...
public class ConfiguredVariableItemTest {
    ...
    public void testStringGet() throws Exception {
        String expected = "str";
        ConfiguredVariableItem item = new LocalConfiguredVariableItem("test", "testing variable", expected);
    ...
    public void testIntegerSet() throws Exception {
        ConfiguredVariableItem item = new LocalConfiguredVariableItem("test", "testing variable", 5);
    ...
    public void testDoubleSet() throws Exception {
        ConfiguredVariableItem item = new LocalConfiguredVariableItem("test", "testing variable", 5.0);
    ...
    public void testTimeStampSet() throws Exception {
        Date now = new Date();
        ConfiguredVariableItem item = new LocalConfiguredVariableItem("test", "testing variable", now);
